...
const SearchPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      <div className="flex flex-col md:flew-row justify-between gap-10">
        <FilterPage />
                ...
                {["Biryani", "Momo", "Jalebi"].map(
                  (selectedFilter: string, idx: number) => (
                    ...
                    >
                      ...
                      <X
                        size={16}
                        className="absolute-text text-[#D19254] right-1 hover:cursor-pointer"
                      />
                    </div>
                  )
                )}
